...
![创建存储卷入口](/faviconassets/images/budiuyun/nginx/2.png)

### 2. 配置存储卷参数

![存储卷配置](/faviconassets/images/budiuyun/nginx/3.png)
...
![创建成功](/faviconassets/images/budiuyun/nginx/4.png)
...
![存储卷挂载](/faviconassets/images/budiuyun/nginx/9.png)
...
![工作负载管理](/faviconassets/images/budiuyun/nginx/11.png)

在工作负载页面中找到刚创建的应用，点击 **管理** 查看详细信息。

### 查看容器详情

![容器详情](/faviconassets/images/budiuyun/nginx/12.png)
