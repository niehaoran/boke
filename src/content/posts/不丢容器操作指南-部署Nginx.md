...
![概览页面资源检查](/src/assets/images/budiuyun/nginx/1.png)
...
![创建存储卷入口](/src/assets/images/budiuyun/nginx/2.png)

### 2. 配置存储卷参数

![存储卷配置](/src/assets/images/budiuyun/nginx/3.png)
...
![创建成功](/src/assets/images/budiuyun/nginx/4.png)
...
![创建工作负载](/src/assets/images/budiuyun/nginx/5.png)

### 2. 选择配置方式

![配置界面选择](/src/assets/images/budiuyun/nginx/6.png)
...
![基本配置](/src/assets/images/budiuyun/nginx/7.png)
...
![端口配置](/src/assets/images/budiuyun/nginx/8.png)
...
![存储卷挂载](/src/assets/images/budiuyun/nginx/9.png)
...
![应用配置](/src/assets/images/budiuyun/nginx/10.png)
...
![工作负载管理](/src/assets/images/budiuyun/nginx/11.png)

在工作负载页面中找到刚创建的应用，点击 **管理** 查看详细信息。

### 查看容器详情

![容器详情](/src/assets/images/budiuyun/nginx/12.png)
...
![创建服务](/src/assets/images/budiuyun/nginx/13.png)

进入服务页面，点击 **快速创建服务**

### 2. 创建应用路由

![创建路由](/src/assets/images/budiuyun/nginx/14.png)

进入应用路由列表，点击 **创建路由**

### 3. 配置路由规则

![路由配置](/src/assets/images/budiuyun/nginx/15.png)
...
![访问域名](/src/assets/images/budiuyun/nginx/16.png)
...
![部署成功](/src/assets/images/budiuyun/nginx/17.png)
