...
欢迎来到不丢云的第一个实战教程！在这个教程中，你将学会如何**1分钟**部署一个可公网访问的静态网站服务器。

## 为什么要用 Nginx 容器？

在不丢云平台中，**应用路由（Ingress）已经为你处理了域名、SSL证书、负载均衡等复杂的网络配置**。你的 Nginx 容器只需要专注于一件事：**高效地提供静态文件服务**。
...
![概览页面资源检查](../../assets/images/budiuyun/nginx/1.png)
...
![创建存储卷入口](../../assets/images/budiuyun/nginx/2.png)

### 2. 配置存储卷参数

![存储卷配置](../../assets/images/budiuyun/nginx/3.png)
...
![创建成功](../../assets/images/budiuyun/nginx/4.png)
...
![创建工作负载](../../assets/images/budiuyun/nginx/5.png)

### 2. 选择配置方式

![配置界面选择](../../assets/images/budiuyun/nginx/6.png)
...
![基本配置](../../assets/images/budiuyun/nginx/7.png)
...
![端口配置](../../assets/images/budiuyun/nginx/8.png)
...
![存储卷挂载](../../assets/images/budiuyun/nginx/9.png)
...
![应用配置](../../assets/images/budiuyun/nginx/10.png)
...
![工作负载管理](../../assets/images/budiuyun/nginx/11.png)

在工作负载页面中找到刚创建的应用，点击 **管理** 查看详细信息。

### 查看容器详情

![容器详情](../../assets/images/budiuyun/nginx/12.png)
...
![创建服务](../../assets/images/budiuyun/nginx/13.png)

进入服务页面，点击 **快速创建服务**

### 2. 创建应用路由

![创建路由](../../assets/images/budiuyun/nginx/14.png)

进入应用路由列表，点击 **创建路由**

### 3. 配置路由规则

![路由配置](../../assets/images/budiuyun/nginx/15.png)
...
![访问域名](../../assets/images/budiuyun/nginx/16.png)
...
![部署成功](../../assets/images/budiuyun/nginx/17.png)
...
:::note[学习建议]
建议继续学习：
- [工作负载管理](/posts/不丢云操作指南-工作负载/) - 深入了解容器管理
- [配置字典](/posts/不丢云操作指南-配置字典/) - 学习高级配置管理
- [MySQL 数据库部署](/posts/不丢云操作指南-部署mysql/) - 数据库服务部署（即将发布）
:::
...
**总结**：通过这个教程，你学会了不丢云平台的核心优势 - **应用路由自动处理复杂的网络配置，让你专注于业务逻辑**。这种架构设计让容器化部署变得简单高效，无需深入了解传统的域名解析、SSL证书配置等复杂运维知识。
...
**基础理论学习：**
- [快速入门篇](/posts/不丢云操作指南-快速入门篇/) - 平台介绍和完整学习路径
- [概览界面](/posts/不丢云操作指南-概览/) - 了解资源配额和监控

**核心功能详解：**
- [工作负载管理](/posts/不丢云操作指南-工作负载/) - 本教程涉及的核心概念详解
- [服务与应用路由](/posts/不丢云操作指南-服务与应用路由/) - 外网访问的完整配置说明

**高级配置：**
- [配置字典](/posts/不丢云操作指南-配置字典/) - 自定义 Nginx 配置文件管理
